                    ...
                    <div class="shipping_books">
                        ...
                        <div class="shipping_content">
                            ...
                            <div class="shipping_button">
                                 ...
                                 */
                                echo CHtml::button('Remove from WishList', array("class" => "remove_shipping",
                                    "onclick" => "if(confirm('Are you want to remove this item from wish list')){
                                     jQuery.ajax({
                                          type: 'POST',
                                         'dataType' : 'json',
                                          url: '" . $this->createUrl("/web/wishList/editwishlist") . "',
                                          async: false,
                                          data: {
