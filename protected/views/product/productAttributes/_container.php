        ...
        <div class="main">
            ...
            <div class="form_body">
                <div class="grid_title">
                    <div class="title" style="width:300px"><?php echo CHtml::activeLabel($relateModelobj, 'product_attribute_conf_id'); ?></div>
                    <div class="title" style="width:300px"><?php echo CHtml::activeLabel($relateModelobj, 'attribute_value'); ?></div>
