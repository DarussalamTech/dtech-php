        ...
        <div class="main">
            ...
            <div class="form_body">
                <div class="grid_title">
                    <div class="title" style="width:200px"><?php echo CHtml::activeLabel($relateModelobj, 'language'); ?></div>
                    <div class="title" style="width:200px"><?php echo CHtml::activeLabel($relateModelobj, 'message'); ?></div>
