        ...
        <div class="main">
            ...
            <div class="form_body">
                <div class="grid_title">
                    <div class="title" style="width:200px"><?php echo CHtml::activeLabelEx($relateModelobj, 'language_id'); ?></div>
                    <div class="title" style="width:200px"><?php echo CHtml::activeLabelEx($relateModelobj, 'title'); ?></div>
                    <div class="title" style="width:200px"><?php echo CHtml::activeLabelEx($relateModelobj, 'weight'); ?></div>
