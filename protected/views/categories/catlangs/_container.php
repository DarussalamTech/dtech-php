...
$heading = "Category Language Translation";
        ...
        <div class="main">
            ...
            <div class="form_body">
                <div class="grid_title">
                    <div class="title" style="width:200px"><?php echo CHtml::activeLabel($relateModelobj, 'category_name'); ?></div>
                    <div class="title" style="width:200px"><?php echo CHtml::activeLabel($relateModelobj, 'lang_id'); ?></div>
                ...
                if ($type == "form") {
                    ...
                    <div class="form submit-btn-div">
                        <?php
                        /**
                         * for handling childrens
                         */
                        echo CHtml::hiddenField("children", "yes");
                        ?>
