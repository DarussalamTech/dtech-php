                        ...
                        <div id="landing_banner">
                            <div class="landing_logo_part">
                                ...
                                <div class="landing_logo_right">
                                    <?php echo CHtml::image(Yii::app()->theme->baseUrl . "/images/engineering.png", 'underconstruction', array("class" => "hat")); ?>
                                    <?php
                                    echo "<b class='hat-text'>Site is Under Construction</b>";
                                    ?>
                                </div>
                            </div>
                            <div class="numbers">
