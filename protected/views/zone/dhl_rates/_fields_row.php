...
<div class="grid_fields" style="display:<?php echo $display; ?>">
    ...
    <div class="field" style="width:200px">
        ...
        echo CHtml::activeTextField($model, '[' . $index . ']weight');
        ?>
    </div>

    <div class="field" style="width:200px">
        <?php
        echo CHtml::activeTextField($model, '[' . $index . ']rate');
        echo CHtml::activeHiddenField($model, '[' . $index . ']rate_type', array("value" => "dhl"));
        ?>
    </div>
