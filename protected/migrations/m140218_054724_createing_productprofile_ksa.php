...
class m140218_054724_createing_productprofile_ksa extends DTDbMigration {
    ...
    public function up() {
        ...
        $prod_prof = $this->getQueryAll("SELECT t.product_id,item_code,language_id FROM `product_profile` as t left join product on t.product_id=product.product_id where product.city_id=" . $lhr[0]);
