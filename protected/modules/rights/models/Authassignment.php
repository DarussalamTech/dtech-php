...
class Authassignment extends CActiveRecord {
    ...
    public function rules() {
        ...
        return array(
            ...
            array('itemname, userid', 'length', 'max' => 250),
    ...
    /**
     * check whether give user is city admin or not
     * 
     * @param type $user_id
     */
    public function isCityAdmin($user_id){
        $criteria = new CDbCriteria;
        $criteria->addCondition("itemname ='CityAdmin' AND user_id =".$user_id);
