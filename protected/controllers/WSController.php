...
class WSController extends Controller {
    ...
    * update the user by calling finalizeOrderPlacement function
    * All this process will be done in the DTWSOrderManager Class available on path
    * (protected/components/classes/)
    * 
    * @param type $request_list
    * @return type Json::response success or failure to the web request made from publisher
    */
    public function placeOrderFromPublisher($request_list) {
        return DTWSOrderManager::getInstance()->placeOrderPub($request_list);
    }
}
