...
class UserStatus extends DTActiveRecord {
    ...
    public function attributeLabels() {
        return array(
            'status_id' => Yii::t('model_labels', 'Status', array(), NULL, Yii::app()->controller->currentLang),
            'status_title' => Yii::t('model_labels', 'Status Title', array(), NULL, Yii::app()->controller->currentLang),
        );
    }
