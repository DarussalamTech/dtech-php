...
class ETinyMce extends CInputWidget {
    ...
    protected function makeFullEditor($url = '') {
        ...
        $this->plugins = array('jbimages,safari', 'pagebreak', 'style', 'layer', 'table', 'save', 'advhr', 'advimage', 'advlink', 'emotions', 'spellchecker', 'inlinepopups', 'insertdatetime', 'preview', 'media', 'searchreplace', 'print', 'contextmenu', 'paste', 'directionality', 'fullscreen', 'noneditable', 'visualchars', 'nonbreaking', 'xhtmlxtras', 'template');
        ...
        $options['theme_advanced_buttons3'] = "justifyleft,justifycenter,justifyright,justifyfull,|,bullist,numlist,|,outdent,indent,|,hr,advhr,nonbreaking,pagebreak,blockquote,|,charmap,emotions,media,image,jbimages,|,link,unlink,anchor,|,insertdate,inserttime";
    ...
    protected function makeCompressor() {
        ...
        $options['debug'] = false;
        $options['uploader_view'] = Yii::app()->controller->createUrl("/commonSystem/tinyUploadlayout");
