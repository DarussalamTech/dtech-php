...
$rules_admin = array(
    ...
    '<country:[\w-\.]+>/<city:[\w-\.]+>/<city_id:[\w-\.]+>/rights/authItem/sortable' => '/rights/authItem/sortable/',
    '<country:[\w-\.]+>/<city:[\w-\.]+>/<city_id:[\w-\.]+>/rights/authItem/operations' => '/rights/authItem/operations/',
    ...
    '<country:[\w-\.]+>/<city:[\w-\.]+>/<city_id:[\w-\.]+>/log' => '/log/index',
    '<country:[\w-\.]+>/<city:[\w-\.]+>/<city_id:[\w-\.]+>/log/htaccess' => '/log/htAccess',
    '<country:[\w-\.]+>/<city:[\w-\.]+>/<city_id:[\w-\.]+>/log/robote' => '/log/robote',
   );
?>
